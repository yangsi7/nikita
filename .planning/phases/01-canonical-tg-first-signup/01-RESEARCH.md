...
| REQ-013 / FR-12 | `telegram_signup_sessions`, `telegram_link_codes`, `pending_registrations` tables dropped in PR-C migration | Tables confirmed present; FK/RLS/cron deps identified |
