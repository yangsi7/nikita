...
| **GSD** | Get Shit Done — phase-based development workflow (`/gsd:spec-phase` → `/gsd:plan-phase` → `/gsd:execute-phase` → `/gsd:verify-work`). Canonical home: `~/.claude/get-shit-done/workflows/`. | `.claude/CLAUDE.md` §"GSD Enforcement" | — |
