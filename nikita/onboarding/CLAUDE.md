...
- **Firecrawl `fetch_*` tools** in `nikita/agents/onboarding/v2/research_agent.py:32` — fan-out tool pattern; borderline against anti-pattern in `.claude/rules/agentic-design-patterns.md` §3. (Predecessor cite `conversation_agent.py:284-287` deleted in Spec 218.)
