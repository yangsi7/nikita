...
export default function VoiceMonitorPage() {
  ...
  const { data, isLoading, error, refetch } = useQuery({
    queryKey: ["admin", "voice", "conversations", page],
    queryFn: () => adminApi.getVoiceConversations({ page }),
  ...
  if (!data?.conversations?.length) return <EmptyState message="No voice conversations yet" />
