...
import { SceneStep } from "@/app/onboarding/steps/legacy/SceneStep"
...
import { PhoneStep } from "@/app/onboarding/steps/legacy/PhoneStep"
...
export interface LegacyOnboardingWizardProps {
  userId: string
}

export function LegacyOnboardingWizard({ userId }: LegacyOnboardingWizardProps) {
